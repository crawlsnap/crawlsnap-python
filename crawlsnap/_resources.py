...
class SportSnap(_Resource):
    ...
    @overload
    def channel_repeats(self, slug: str, iso_code: str = "", *, cursor: Optional[str] = None, raw_response: Literal[False] = False) -> ChannelRepeatsData: ...
    @overload
    def channel_repeats(self, slug: str, iso_code: str = "", *, cursor: Optional[str] = None, raw_response: Literal[True]) -> "RawResponse": ...
    def channel_repeats(self, slug: str, iso_code: str = "", *, cursor: Optional[str] = None, raw_response: bool = False) -> Any:
        ...
        if cursor:
            params["cursor"] = cursor
        return self._client._request(f"{self._base}/channels/{_seg(slug)}/repeat", params, ChannelRepeatsData, raw_response=raw_response)
