...
from crawlsnap.configuration import Configuration
from crawlsnap.api_response import ApiResponse, T as ApiResponseT
import crawlsnap.models
from crawlsnap import rest
from crawlsnap.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(crawlsnap.models, klass)
