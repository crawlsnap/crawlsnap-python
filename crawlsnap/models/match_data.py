...
class MatchData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competition", "fixture"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "competition": MatchCompetition.from_dict(obj["competition"]) if obj.get("competition") is not None else None,
            "fixture": MatchFixture.from_dict(obj["fixture"]) if obj.get("fixture") is not None else None
        })
        return _obj
