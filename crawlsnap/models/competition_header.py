...
class CompetitionHeader(BaseModel):
    """
    CompetitionHeader
    """ # noqa: E501
    ...
    news_url: Optional[StrictStr] = Field(default=None, description="Source-relative news path, e.g. `/news/tags/world-cup`.")
    __properties: ClassVar[List[str]] = ["competition_id", "country", "country_trans", "slug", "competition", "competition_url", "news_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionHeader from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionHeader from a dict"""
        if obj is None:
            return None
