...
class CountryTeams(BaseModel):
    """
    CountryTeams
    """ # noqa: E501
    country: Optional[StrictStr] = None
    country_trans: Optional[StrictStr] = None
    slug: Optional[StrictStr] = Field(default=None, description="Slug usable with `/api/v1/countries/{slug}`.")
    country_team: Optional[StrictStr] = None
    country_women_team: Optional[StrictStr] = None
    slug_women: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["country", "country_trans", "slug", "country_team", "country_women_team", "slug_women"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountryTeams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountryTeams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "slug": obj.get("slug"),
            "country_team": obj.get("country_team"),
            "country_women_team": obj.get("country_women_team"),
            "slug_women": obj.get("slug_women")
        })
        return _obj
