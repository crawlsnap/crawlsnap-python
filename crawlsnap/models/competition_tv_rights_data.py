...
class CompetitionTvRightsData(BaseModel):
    """
    CompetitionTvRightsData
    """ # noqa: E501
    competition: CompetitionHeader
    tv_rights: List[TvRight]
    __properties: ClassVar[List[str]] = ["competition", "tv_rights"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionTvRightsData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionTvRightsData from a dict"""
        if obj is None:
            return None
