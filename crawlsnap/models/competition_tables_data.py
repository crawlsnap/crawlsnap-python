...
class CompetitionTablesData(BaseModel):
    """
    CompetitionTablesData
    """ # noqa: E501
    competition: CompetitionHeader
    tables: List[TableGroup]
    __properties: ClassVar[List[str]] = ["competition", "tables"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionTablesData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionTablesData from a dict"""
        if obj is None:
            return None
