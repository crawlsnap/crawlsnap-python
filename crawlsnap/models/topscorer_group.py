...
class TopscorerGroup(BaseModel):
    """
    TopscorerGroup
    """ # noqa: E501
    id: Optional[StrictStr] = None
    stage: Optional[StrictStr] = None
    topscorers: Optional[List[Topscorer]] = None
    __properties: ClassVar[List[str]] = ["id", "stage", "topscorers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TopscorerGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TopscorerGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "stage": obj.get("stage"),
            "topscorers": [Topscorer.from_dict(_item) for _item in obj["topscorers"]] if obj.get("topscorers") is not None else None
        })
        return _obj
