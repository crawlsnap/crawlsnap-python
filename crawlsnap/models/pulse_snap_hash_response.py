...
class PulseSnapHashResponse(BaseModel):
    """
    PulseSnapHashResponse
    """ # noqa: E501
    data: Optional[PulseHashScanData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PulseHashScanData.from_dict(obj["data"]) if obj.get("data") is not None else None,
