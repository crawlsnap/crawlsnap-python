...
class PopularTeamsData(BaseModel):
    """
    PopularTeamsData
    """ # noqa: E501
    teams: List[PopularTeam] = Field(description="Lifted from the source's `teams.teams_popular` wrapper.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopularTeamsData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopularTeamsData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "teams": [PopularTeam.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
