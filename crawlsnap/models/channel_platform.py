...
class ChannelPlatform(BaseModel):
    """
    ChannelPlatform
    """ # noqa: E501
    platform: Optional[StrictStr] = None
    url: Optional[StrictStr] = Field(default=None, description="Empty when the source value had to be sanitized.")
    note: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["platform", "url", "note"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelPlatform from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelPlatform from a dict"""
        if obj is None:
            return None
