...
class NewsListData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["articles", "news_lang", "news_lang_hint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewsListData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewsListData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "articles": [NewsArticle.from_dict(_item) for _item in obj["articles"]] if obj.get("articles") is not None else None,
