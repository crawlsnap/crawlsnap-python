...
class CountryChannel(BaseModel):
    """
    CountryChannel
    """ # noqa: E501
    name: StrictStr
    slug: Optional[StrictStr] = Field(default=None, description="Channel slug usable with `/api/v1/channels/{slug}`; null when never linked by the source.")
    last_seen: datetime = Field(description="Last time this channel was observed for this country in crawled data.")
    __properties: ClassVar[List[str]] = ["name", "slug", "last_seen"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountryChannel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountryChannel from a dict"""
        if obj is None:
            return None
