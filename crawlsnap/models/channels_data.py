...
class ChannelsData(BaseModel):
    ...
    ChannelsData
    """ # noqa: E501
    country: Optional[ChannelsDataCountry] = None
    channels: List[ChannelListing]
    __properties: ClassVar[List[str]] = ["country", "channels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelsData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelsData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "country": ChannelsDataCountry.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "channels": [ChannelListing.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None
        })
        return _obj
