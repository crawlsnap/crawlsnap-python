...
class CompetitionsData(BaseModel):
    ...
    CompetitionsData
    """ # noqa: E501
    competitions: CompetitionsDataCompetitions
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionsData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of competitions
        if self.competitions:
            _dict['competitions'] = self.competitions.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionsData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "competitions": CompetitionsDataCompetitions.from_dict(obj["competitions"]) if obj.get("competitions") is not None else None
        })
        return _obj
