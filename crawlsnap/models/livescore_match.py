...
class LivescoreMatch(BaseModel):
    ...
    LivescoreMatch
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Match id usable with `/api/v1/match/{id}`.")
    game: Optional[StrictStr] = Field(default=None, description="Display line including the running score, e.g. \"BATE II 1 - 4 Lida\".")
    result: Optional[StrictStr] = None
    cid: Optional[StrictStr] = Field(default=None, description="Competition id.")
    rank: Optional[StrictStr] = None
    status: Optional[StrictStr] = Field(default=None, description="FT, HT, Cancl., a running minute, or empty.")
    timer: Optional[StrictStr] = None
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    time: Optional[StrictStr] = None
    events: Optional[List[LivescoreEvent]] = None
    __properties: ClassVar[List[str]] = ["id", "game", "result", "cid", "rank", "status", "timer", "date", "time", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LivescoreMatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LivescoreMatch from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "time": obj.get("time"),
            "events": [LivescoreEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
