...
class NewsArticleDetail(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="Article author byline.")
    language: Optional[StrictStr] = None
    content: Optional[StrictStr] = Field(default=None, description="Article body HTML.")
    excerpt: Optional[StrictStr] = None
    special_url: Optional[StrictStr] = None
    tags: Optional[StrictStr] = None
    tags_arr: Optional[List[StrictStr]] = None
    team_ids: Optional[StrictStr] = Field(default=None, description="Space-separated team ids.")
    __properties: ClassVar[List[str]] = ["article_id", "status", "title", "slug", "publish_date", "source", "language", "content", "excerpt", "special_url", "tags", "tags_arr", "team_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewsArticleDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewsArticleDetail from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "special_url": obj.get("special_url"),
            "tags": obj.get("tags"),
            "tags_arr": obj.get("tags_arr"),
