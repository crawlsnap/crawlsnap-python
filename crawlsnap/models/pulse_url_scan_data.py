...
class PulseUrlScanData(BaseModel):
    ...
    pulse_detail: Optional[Dict[str, Any]] = Field(default=None, description="OTX-derived pulse summary. Inner shape evolves with upstream; kept free-form on purpose (see phase-2 plan Decision #5). ")
