...
class MatchesData(BaseModel):
    ...
    MatchesData
    """ # noqa: E501
    competitions: List[CompetitionFixtures]
    __properties: ClassVar[List[str]] = ["competitions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchesData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchesData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "competitions": [CompetitionFixtures.from_dict(_item) for _item in obj["competitions"]] if obj.get("competitions") is not None else None
        })
        return _obj
