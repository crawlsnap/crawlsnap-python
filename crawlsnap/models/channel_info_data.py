...
class ChannelInfoData(BaseModel):
    """
    ChannelInfoData
    """ # noqa: E501
    channel: ChannelInfo
    tv_rights: Optional[List[TvRight]] = None
    __properties: ClassVar[List[str]] = ["channel", "tv_rights"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelInfoData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelInfoData from a dict"""
        if obj is None:
            return None
