...
class TeamCompetition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competition_id", "country", "continent", "competition", "slug", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamCompetition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamCompetition from a dict"""
        if obj is None:
            return None
