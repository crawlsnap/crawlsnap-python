...
class ChannelRepeatsData(BaseModel):
    """
    ChannelRepeatsData
    """ # noqa: E501
    channel: ChannelInfo
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelRepeatsData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelRepeatsData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "channel": ChannelInfo.from_dict(obj["channel"]) if obj.get("channel") is not None else None,
