...
class CompetitionListItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competition_id", "name", "slug", "country", "country_trans", "continent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionListItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionListItem from a dict"""
        if obj is None:
            return None
