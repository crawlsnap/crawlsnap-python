...
class MatchCompetition(BaseModel):
    ...
    country_trans: Optional[StrictStr] = None
    continent: Optional[StrictStr] = None
    url: Optional[StrictStr] = Field(default=None, description="Path usable with `/api/v1/competitions/{country}/{slug}`.")
    show_country: Optional[StrictStr] = Field(default=None, description="Y/N.")
    competition_translations: Optional[Dict[str, StrictStr]] = Field(default=None, description="Locale-keyed translated strings (e.g. `{\"tr\": \"Dünya Kupası\"}`). Present only on extended (`x*`) endpoints and only for locales the source translates. ")
    __properties: ClassVar[List[str]] = ["competition_id", "slug", "competition", "country", "country_trans", "continent", "url", "show_country", "competition_translations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchCompetition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchCompetition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "country_trans": obj.get("country_trans"),
            "continent": obj.get("continent"),
            "url": obj.get("url"),
            "show_country": obj.get("show_country"),
            "competition_translations": obj.get("competition_translations")
        })
        return _obj
