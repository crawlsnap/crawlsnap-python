...
class SquadPlayer(BaseModel):
    ...
    position: Optional[StrictStr] = Field(default=None, description="G, D, M or F.")
    ...
    __properties: ClassVar[List[str]] = ["id", "slug", "name", "number", "first_name", "last_name", "nationality", "position", "goals", "assists", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SquadPlayer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SquadPlayer from a dict"""
        if obj is None:
            return None
