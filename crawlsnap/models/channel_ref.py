...
class ChannelRef(BaseModel):
    ...
    local: Optional[StrictStr] = Field(default=None, description="1 when the channel is local to the requested region.")
    __properties: ClassVar[List[str]] = ["slug", "name", "local"]
