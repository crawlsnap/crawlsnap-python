...
class LivescoreEvent(BaseModel):
    ...
    LivescoreEvent
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="goal, yellowcard, redcard, substitution, ...")
    ...
    result: Optional[StrictStr] = Field(default=None, description="Score after the event for goals, e.g. \"[1 - 0]\".")
    ...
    __properties: ClassVar[List[str]] = ["type", "minute", "extra_min", "team", "player", "result", "assist", "assistId", "playerIn", "playerInId", "playerOut", "playerOutId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LivescoreEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LivescoreEvent from a dict"""
        if obj is None:
            return None
