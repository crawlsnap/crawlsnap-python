...
class TableGroup(BaseModel):
    ...
    TableGroup
    """ # noqa: E501
    tournament: Optional[StrictStr] = Field(default=None, description="Stage name, e.g. \"Group A\".")
    tables: Optional[List[TableRow]] = None
    __properties: ClassVar[List[str]] = ["tournament", "tables"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tables": [TableRow.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
