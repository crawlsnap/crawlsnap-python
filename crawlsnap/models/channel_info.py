...
class ChannelInfo(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="The channel's own website.")
    buy_url: Optional[StrictStr] = None
    coverage: Optional[StrictStr] = None
    quality: Optional[StrictStr] = None
    coverage_translations: Optional[Dict[str, StrictStr]] = Field(default=None, description="Locale-keyed translated strings (e.g. `{\"tr\": \"Dünya Kupası\"}`). Present only on extended (`x*`) endpoints and only for locales the source translates. ")
    __properties: ClassVar[List[str]] = ["channel_id", "slug", "name", "description", "platform", "url", "buy_url", "coverage", "quality", "coverage_translations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "buy_url": obj.get("buy_url"),
            "coverage": obj.get("coverage"),
            "quality": obj.get("quality"),
            "coverage_translations": obj.get("coverage_translations")
        })
        return _obj
