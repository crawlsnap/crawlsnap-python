...
class PopularTeam(BaseModel):
    ...
    slug: Optional[StrictStr] = Field(default=None, description="Source-relative team path, e.g. `/countries/usa/` or `/teams/spain/barcelona/`.")
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["club_id", "country", "country_trans", "slug", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopularTeam from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopularTeam from a dict"""
        if obj is None:
            return None
