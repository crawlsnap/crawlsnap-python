...
class CompetitionFixtures(BaseModel):
    """
    CompetitionFixtures
    """ # noqa: E501
    ...
    popular: Optional[StrictStr] = Field(default=None, description="Y/N.")
    competition_url: Optional[StrictStr] = Field(default=None, description="Path usable with `/api/v1/competitions/{country}/{slug}`.")
    fixtures: Optional[List[FixtureSummary]] = None
    __properties: ClassVar[List[str]] = ["id", "country", "country_trans", "continent", "competition", "slug", "popular", "competition_url", "fixtures"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionFixtures from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionFixtures from a dict"""
        if obj is None:
            return None
