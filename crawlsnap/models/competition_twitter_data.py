...
class CompetitionTwitterData(BaseModel):
    """
    CompetitionTwitterData
    """ # noqa: E501
    items: List[Dict[str, Any]] = Field(description="Social feed items; free-form (observed empty), sanitized like every payload.")
    next: Optional[StrictStr] = None
    prev: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["items", "next", "prev"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionTwitterData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionTwitterData from a dict"""
        if obj is None:
            return None
