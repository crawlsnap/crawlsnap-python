...
class AllTeamsData(BaseModel):
    """
    AllTeamsData
    """ # noqa: E501
    teams: List[CountryTeams] = Field(description="Lifted from the source's `teams.teams_all` wrapper.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllTeamsData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllTeamsData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "teams": [CountryTeams.from_dict(_item) for _item in obj["teams"]] if obj.get("teams") is not None else None
        })
        return _obj
