...
class ChannelListing(BaseModel):
    ...
    slug: Optional[StrictStr] = Field(default=None, description="Slug usable with `/api/v1/channels/{slug}/info`.")
    country: Optional[StrictStr] = Field(default=None, description="Pipe-delimited country list as sent by the source.")
    countries: Optional[StrictStr] = None
    regional: Optional[StrictStr] = None
    city: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    platform: Optional[StrictStr] = Field(default=None, description="TV, Stream, Radio, ...")
    radio_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["channel_id", "name", "slug", "country", "countries", "regional", "city", "state", "platform", "radio_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelListing from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelListing from a dict"""
        if obj is None:
            return None
