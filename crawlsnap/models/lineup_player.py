...
class LineupPlayer(BaseModel):
    ...
    field_position: Optional[StrictStr] = Field(default=None, description="G, D, M or F.")
    formation_position: Optional[StrictStr] = Field(default=None, description="Slot in the formation; S for substitutes.")
    url: Optional[StrictStr] = Field(default=None, description="Player path usable with `/api/v1/player/{slug}/{id}`.")
    __properties: ClassVar[List[str]] = ["id", "no", "name", "field_position", "formation_position", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LineupPlayer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LineupPlayer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "no": obj.get("no"),
            "name": obj.get("name"),
            "field_position": obj.get("field_position"),
            "formation_position": obj.get("formation_position"),
            "url": obj.get("url")
        })
        return _obj
