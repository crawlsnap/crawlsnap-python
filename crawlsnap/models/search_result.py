...
class SearchResult(BaseModel):
    ...
    SearchResult
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="team, competition, match or player.")
    url: Optional[StrictStr] = Field(default=None, description="Source-relative path resolvable with the matching endpoint of this API.")
    title: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    description_orig: Optional[StrictStr] = None
    timestamp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "url", "title", "description", "description_orig", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description_orig": obj.get("description_orig"),
