...
class PlayerProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "slug", "name", "first_name", "last_name", "nationality", "position", "no", "height", "weight", "birthday"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerProfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerProfile from a dict"""
        if obj is None:
            return None
