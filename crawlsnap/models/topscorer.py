...
class Topscorer(BaseModel):
    ...
    penalty_goals: Optional[StrictStr] = None
    url: Optional[StrictStr] = Field(default=None, description="Player path usable with `/api/v1/player/{slug}/{id}`.")
    __properties: ClassVar[List[str]] = ["club_id", "position", "name", "team", "goals", "penalty_goals", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Topscorer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Topscorer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "team": obj.get("team"),
            "goals": obj.get("goals"),
            "penalty_goals": obj.get("penalty_goals"),
            "url": obj.get("url")
        })
        return _obj
