...
class TvRight(BaseModel):
    """
    TvRight
    """ # noqa: E501
    channel_id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    lname: Optional[StrictStr] = None
    ...
    season_from: Optional[StrictStr] = None
    season_to: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["channel_id", "name", "lname", "slug", "platform", "description", "expiry", "comments", "season_from", "season_to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TvRight from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TvRight from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "season_from": obj.get("season_from"),
            "season_to": obj.get("season_to")
        })
        return _obj
