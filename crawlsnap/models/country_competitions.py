...
class CountryCompetitions(BaseModel):
    """
    CountryCompetitions
    """ # noqa: E501
    country: Optional[StrictStr] = None
    country_trans: Optional[StrictStr] = None
    competitions: Optional[List[CompetitionListItem]] = None
    __properties: ClassVar[List[str]] = ["country", "country_trans", "competitions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountryCompetitions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountryCompetitions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "competitions": [CompetitionListItem.from_dict(_item) for _item in obj["competitions"]] if obj.get("competitions") is not None else None
        })
        return _obj
