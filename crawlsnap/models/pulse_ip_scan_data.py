...
class PulseIpScanData(BaseModel):
    """
    PulseIpScanData
    """ # noqa: E501
    ...
    malware: Optional[List[Dict[str, Any]]] = None
    passive_dns: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["crawlsnap_hash_id", "search_type", "pulse_detail", "malware", "passive_dns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "passive_dns": obj.get("passive_dns")
        })
        return _obj
