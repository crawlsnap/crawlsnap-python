...
class SubdoSnapScanResponse(BaseModel):
    """
    SubdoSnapScanResponse
    """ # noqa: E501
    data: Optional[SubdoSnapScanData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SubdoSnapScanData.from_dict(obj["data"]) if obj.get("data") is not None else None,
