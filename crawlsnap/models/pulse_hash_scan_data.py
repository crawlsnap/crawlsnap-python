...
class PulseHashScanData(BaseModel):
    """
    PulseHashScanData
    """ # noqa: E501
    crawlsnap_hash_id: StrictStr
    search_type: StrictStr
    pulse_detail: Optional[Dict[str, Any]] = None
    analysis: Optional[Dict[str, Any]] = Field(default=None, description="Sandbox analysis output (free-form). Curated before return/cache: low-value raw dumps are removed and long-tail arrays capped; all IOCs are preserved. ")
    __properties: ClassVar[List[str]] = ["crawlsnap_hash_id", "search_type", "pulse_detail", "analysis"]
