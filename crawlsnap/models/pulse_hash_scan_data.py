...
class PulseHashScanData(BaseModel):
    ...
    analysis: Optional[Dict[str, Any]] = Field(default=None, description="Hybrid Analysis sandbox + Cuckoo plugin output (free-form). The Cuckoo output is curated before return/cache: low-value raw dumps are removed and long-tail arrays capped; all IOCs are preserved. ")
