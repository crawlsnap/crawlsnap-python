...
class CompetitionSchedule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competition", "matches"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompetitionSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompetitionSchedule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "matches": [ScheduledMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
