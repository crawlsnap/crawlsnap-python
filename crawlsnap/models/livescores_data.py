...
class LivescoresData(BaseModel):
    """
    LivescoresData
    """ # noqa: E501
    sport: StrictStr
    updated: StrictStr = Field(description="Source-side refresh time, `YYYY-MM-DD HH:MM:SS`.")
    matches: List[LivescoreMatch]
    __properties: ClassVar[List[str]] = ["sport", "updated", "matches"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LivescoresData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LivescoresData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "matches": [LivescoreMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
