...
class NewsArticle(BaseModel):
    ...
    NewsArticle
    """ # noqa: E501
    article_id: Optional[StrictStr] = Field(default=None, description="Id usable with `/api/v1/news/{id}`.")
    ...
    __properties: ClassVar[List[str]] = ["article_id", "status", "title", "slug", "publish_date", "source", "timestamp"]
