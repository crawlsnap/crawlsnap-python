...
class NewsDetailData(BaseModel):
    ...
    also_articles: Optional[List[NewsArticle]] = None
    news_lang: Optional[StrictStr] = None
    news_lang_hint: Optional[StrictBool] = Field(default=None, description="Whether the source suggests switching the feed language.")
    __properties: ClassVar[List[str]] = ["article", "also_articles", "news_lang", "news_lang_hint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewsDetailData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in also_articles (list)
        _items = []
        if self.also_articles:
            for _item_also_articles in self.also_articles:
                if _item_also_articles:
                    _items.append(_item_also_articles.to_dict())
            _dict['also_articles'] = _items
        # set to None if news_lang_hint (nullable) is None
        # and model_fields_set contains the field
        if self.news_lang_hint is None and "news_lang_hint" in self.model_fields_set:
            _dict['news_lang_hint'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewsDetailData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "article": NewsArticleDetail.from_dict(obj["article"]) if obj.get("article") is not None else None,
            "also_articles": [NewsArticle.from_dict(_item) for _item in obj["also_articles"]] if obj.get("also_articles") is not None else None,
            "news_lang": obj.get("news_lang"),
            "news_lang_hint": obj.get("news_lang_hint")
        })
        return _obj
