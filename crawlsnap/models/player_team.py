...
class PlayerTeam(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="Team path usable with `/api/v1/teams/{country}/{team}`.")
    name: Optional[StrictStr] = None
    slug: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "url", "name", "slug", "country"]
