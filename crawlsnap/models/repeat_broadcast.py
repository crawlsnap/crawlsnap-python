...
class RepeatBroadcast(BaseModel):
    """
    RepeatBroadcast
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["fixture_id", "game", "name", "lname", "slug", "country", "timestamp", "datetime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepeatBroadcast from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepeatBroadcast from a dict"""
        if obj is None:
            return None
