...
class CountryBroadcasts(BaseModel):
    """
    CountryBroadcasts
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["country", "country_code", "country_trans", "channels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CountryBroadcasts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CountryBroadcasts from a dict"""
        if obj is None:
            return None
