...
class PlayerStatRow(BaseModel):
    ...
    team_url: Optional[StrictStr] = None
    competition: Optional[StrictStr] = None
    competition_id: Optional[StrictStr] = None
    competition_url: Optional[StrictStr] = None
    minutes_played: Optional[StrictStr] = None
    appearances: Optional[StrictStr] = None
    lineups: Optional[StrictStr] = None
    subbed_on: Optional[StrictStr] = None
    subbed_off: Optional[StrictStr] = None
    substitute: Optional[StrictStr] = None
    goals: Optional[StrictStr] = None
    yellow_cards: Optional[StrictStr] = None
    yellowred_cards: Optional[StrictStr] = None
    red_cards: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["season", "team", "team_id", "team_url", "competition", "competition_id", "competition_url", "minutes_played", "appearances", "lineups", "subbed_on", "subbed_off", "substitute", "goals", "yellow_cards", "yellowred_cards", "red_cards"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerStatRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerStatRow from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "minutes_played": obj.get("minutes_played"),
            "appearances": obj.get("appearances"),
            "lineups": obj.get("lineups"),
            "subbed_on": obj.get("subbed_on"),
            "subbed_off": obj.get("subbed_off"),
            "substitute": obj.get("substitute"),
            "goals": obj.get("goals"),
            "yellow_cards": obj.get("yellow_cards"),
            "yellowred_cards": obj.get("yellowred_cards"),
            "red_cards": obj.get("red_cards")
        })
        return _obj
