...
class SubdoSnapScanData(BaseModel):
    """
    SubdoSnapScanData
    """ # noqa: E501
    hash_id: StrictStr
    ...
    cursor: Optional[StrictStr] = Field(default=None, description="Opaque pagination cursor for the next page (empty when no more pages).")
    count: Optional[StrictInt] = Field(default=None, description="Total subdomain count reported by upstream.")
    __properties: ClassVar[List[str]] = ["hash_id", "search_type", "subdomains", "cursor", "count"]
