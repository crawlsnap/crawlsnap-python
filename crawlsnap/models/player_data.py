...
class PlayerData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["profile", "team", "stats"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "profile": PlayerProfile.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
            "team": PlayerTeam.from_dict(obj["team"]) if obj.get("team") is not None else None,
            "stats": PlayerStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
