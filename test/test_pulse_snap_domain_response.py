...
class TestPulseSnapDomainResponse(unittest.TestCase):
    """PulseSnapDomainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseSnapDomainResponse:
        """Test PulseSnapDomainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseSnapDomainResponse`
        """
        model = PulseSnapDomainResponse()
        if include_optional:
            return PulseSnapDomainResponse(
                data = crawlsnap.models.pulse_domain_scan_data.PulseDomainScanData(
                    crawlsnap_hash_id = '', 
                    search_type = 'domain', 
                    pulse_detail = { }, 
                    malware = [
    ...
    def testPulseSnapDomainResponse(self):
        """Test PulseSnapDomainResponse"""
