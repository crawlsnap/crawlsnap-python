...
class TestIocDomainScanData(unittest.TestCase):
    """IocDomainScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IocDomainScanData:
        """Test IocDomainScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IocDomainScanData`
        """
        model = IocDomainScanData()
        if include_optional:
            return IocDomainScanData(
                hash_id = '',
                search_type = 'domain',
                domain = '',
                reputation = 56,
    ...
    def testIocDomainScanData(self):
        """Test IocDomainScanData"""
