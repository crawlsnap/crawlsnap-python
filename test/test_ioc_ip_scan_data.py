...
class TestIocIpScanData(unittest.TestCase):
    """IocIpScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IocIpScanData:
        """Test IocIpScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IocIpScanData`
        """
        model = IocIpScanData()
        if include_optional:
            return IocIpScanData(
                hash_id = '',
                search_type = 'ip',
                ip = '',
                country = '',
