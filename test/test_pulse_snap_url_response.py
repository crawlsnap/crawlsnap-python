...
class TestPulseSnapUrlResponse(unittest.TestCase):
    """PulseSnapUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseSnapUrlResponse:
        """Test PulseSnapUrlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseSnapUrlResponse`
        """
        model = PulseSnapUrlResponse()
        if include_optional:
            return PulseSnapUrlResponse(
                data = crawlsnap.models.pulse_url_scan_data.PulseUrlScanData(
                    crawlsnap_hash_id = '', 
                    search_type = 'url', 
                    pulse_detail = { }, ),
                is_success = True,
    ...
    def testPulseSnapUrlResponse(self):
        """Test PulseSnapUrlResponse"""
