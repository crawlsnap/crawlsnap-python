...
from crawlsnap.api.subdo_snap_api import SubdoSnapApi


class TestSubdoSnapApi(unittest.TestCase):
    """SubdoSnapApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SubdoSnapApi()

    def tearDown(self) -> None:
        pass

    def test_subdo_snap_scan(self) -> None:
        """Test case for subdo_snap_scan
