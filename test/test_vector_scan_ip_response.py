...
class TestVectorScanIpResponse(unittest.TestCase):
    """VectorScanIpResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorScanIpResponse:
        """Test VectorScanIpResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorScanIpResponse`
        """
        model = VectorScanIpResponse()
        if include_optional:
            return VectorScanIpResponse(
                data = crawlsnap.models.ioc_ip_scan_data.IocIpScanData(
                    hash_id = '', 
                    search_type = 'ip', 
                    ip = '', 
                    country = '', 
    ...
    def testVectorScanIpResponse(self):
        """Test VectorScanIpResponse"""
