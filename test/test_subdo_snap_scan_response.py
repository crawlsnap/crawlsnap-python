...
class TestSubdoSnapScanResponse(unittest.TestCase):
    """SubdoSnapScanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubdoSnapScanResponse:
        """Test SubdoSnapScanResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubdoSnapScanResponse`
        """
        model = SubdoSnapScanResponse()
        if include_optional:
            return SubdoSnapScanResponse(
                data = crawlsnap.models.subdo_snap_scan_data.SubdoSnapScanData(
                    hash_id = '', 
                    search_type = 'domain', 
                    subdomains = [
                        { }
    ...
    def testSubdoSnapScanResponse(self):
        """Test SubdoSnapScanResponse"""
