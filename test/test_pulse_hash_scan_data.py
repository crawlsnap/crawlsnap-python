...
class TestPulseHashScanData(unittest.TestCase):
    """PulseHashScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseHashScanData:
        """Test PulseHashScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseHashScanData`
        """
        model = PulseHashScanData()
        if include_optional:
            return PulseHashScanData(
                crawlsnap_hash_id = '',
                search_type = 'hash',
                pulse_detail = { },
                analysis = { }
    ...
    def testPulseHashScanData(self):
        """Test PulseHashScanData"""
