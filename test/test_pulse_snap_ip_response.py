...
class TestPulseSnapIpResponse(unittest.TestCase):
    """PulseSnapIpResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseSnapIpResponse:
        """Test PulseSnapIpResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseSnapIpResponse`
        """
        model = PulseSnapIpResponse()
        if include_optional:
            return PulseSnapIpResponse(
                data = crawlsnap.models.pulse_ip_scan_data.PulseIpScanData(
                    crawlsnap_hash_id = '', 
                    search_type = 'ip', 
                    pulse_detail = { }, 
                    malware = [
    ...
    def testPulseSnapIpResponse(self):
        """Test PulseSnapIpResponse"""
