...
class TestPulseIpScanData(unittest.TestCase):
    """PulseIpScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseIpScanData:
        """Test PulseIpScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseIpScanData`
        """
        model = PulseIpScanData()
        if include_optional:
            return PulseIpScanData(
                crawlsnap_hash_id = '',
                search_type = 'ip',
                pulse_detail = { },
                malware = [
