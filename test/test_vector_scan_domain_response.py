...
class TestVectorScanDomainResponse(unittest.TestCase):
    """VectorScanDomainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorScanDomainResponse:
        """Test VectorScanDomainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorScanDomainResponse`
        """
        model = VectorScanDomainResponse()
        if include_optional:
            return VectorScanDomainResponse(
                data = crawlsnap.models.ioc_domain_scan_data.IocDomainScanData(
                    hash_id = '', 
                    search_type = 'domain', 
                    domain = '', 
                    reputation = 56, 
                    ...
                    whois = '', 
                    whois_update_date = 56, 
                    modification_date = 56, 
                    tld = '', 
                    dns_records_update_date = 56, 
                    http_certificate_update_date = 56, 
                    jarm = '', 
                    registrar = '', 
                    analysis_date = 56, 
                    votes_result = { }, 
    ...
    def testVectorScanDomainResponse(self):
        """Test VectorScanDomainResponse"""
