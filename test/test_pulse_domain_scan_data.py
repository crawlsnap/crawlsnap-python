...
class TestPulseDomainScanData(unittest.TestCase):
    """PulseDomainScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PulseDomainScanData:
        """Test PulseDomainScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PulseDomainScanData`
        """
        model = PulseDomainScanData()
        if include_optional:
            return PulseDomainScanData(
                crawlsnap_hash_id = '',
                search_type = 'domain',
                pulse_detail = { },
                malware = [
    ...
    def testPulseDomainScanData(self):
        """Test PulseDomainScanData"""
