...
class TestSubdoSnapScanData(unittest.TestCase):
    """SubdoSnapScanData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubdoSnapScanData:
        """Test SubdoSnapScanData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubdoSnapScanData`
        """
        model = SubdoSnapScanData()
        if include_optional:
            return SubdoSnapScanData(
                hash_id = '',
                search_type = 'domain',
                subdomains = [
                    { }
    ...
    def testSubdoSnapScanData(self):
        """Test SubdoSnapScanData"""
