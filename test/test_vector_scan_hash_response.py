...
class TestVectorScanHashResponse(unittest.TestCase):
    """VectorScanHashResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorScanHashResponse:
        """Test VectorScanHashResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorScanHashResponse`
        """
        model = VectorScanHashResponse()
        if include_optional:
            return VectorScanHashResponse(
                data = crawlsnap.models.ioc_hash_scan_data.IocHashScanData(
                    hash_id = '', 
                    search_type = 'hash', 
                    ssdeep = '', 
                    type_tag = '', 
    ...
    def testVectorScanHashResponse(self):
        """Test VectorScanHashResponse"""
