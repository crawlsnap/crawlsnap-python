...
class TestVectorScanUrlResponse(unittest.TestCase):
    """VectorScanUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VectorScanUrlResponse:
        """Test VectorScanUrlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorScanUrlResponse`
        """
        model = VectorScanUrlResponse()
        if include_optional:
            return VectorScanUrlResponse(
                data = crawlsnap.models.ioc_url_scan_data.IocUrlScanData(
                    hash_id = '', 
                    search_type = 'url', 
                    url = '', 
    ...
    def testVectorScanUrlResponse(self):
        """Test VectorScanUrlResponse"""
