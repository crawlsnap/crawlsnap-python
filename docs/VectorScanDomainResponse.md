...
------------ | ------------- | ------------- | -------------
**data** | [**IocDomainScanData**](IocDomainScanData.md) |  | [optional] 
...
vector_scan_domain_response_instance = VectorScanDomainResponse.from_json(json)
# print the JSON string representation of the object
print(VectorScanDomainResponse.to_json())

# convert the object into a dict
vector_scan_domain_response_dict = vector_scan_domain_response_instance.to_dict()
# create an instance of VectorScanDomainResponse from a dict
vector_scan_domain_response_from_dict = VectorScanDomainResponse.from_dict(vector_scan_domain_response_dict)
```
